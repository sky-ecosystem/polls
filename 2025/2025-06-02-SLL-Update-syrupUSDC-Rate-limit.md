---
title: Spark Liquidity Layer Mainnet - Update syrupUSDC Rate Limits - June 2, 2025
summary: Signal your support or opposition to updating the syrupUSDC Rate Limits for the Spark Liquidity Layer on mainnet.
...
# Poll: Spark Liquidity Layer Mainnet - Update syrupUSDC Rate Limits - June 2, 2025
...
The community can vote in this poll to express support or opposition to the following changes to the syrupUSDC [rate limits](https://docs.spark.fi/dev/spark-liquidity-layer/spark-alm-controller#rate-limits) on mainnet:
