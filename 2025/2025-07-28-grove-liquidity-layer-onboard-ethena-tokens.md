---
title: Grove Liquidity Layer Mainnet - Onboard Ethena sUSDe and USDe - July 28, 2025
summary: Signal your support or opposition to onboarding sUSDe and USDe to the Grove Liquidity Layer on mainnet.
...
# Poll: Grove Liquidity Layer Mainnet - Onboard Ethena sUSDe and USDe - July 28, 2025
...
The community can vote in this poll to express support or opposition to onboarding sUSDe and USDe to the Grove Liquidity Layer with the following [rate limits](https://docs.spark.fi/dev/spark-liquidity-layer/spark-alm-controller#rate-limits):
