---
title: Spark Liquidity Layer Mainnet - Claim Aave Core aUSDS Rewards - September 22, 2025
summary: Signal your support or opposition to claiming Aave Core aUSDS rewards for the Spark Liquidity Layer on mainnet.
...
# Poll: Spark Liquidity Layer Mainnet - Claim Aave Core aUSDS Rewards - September 22, 2025
...
The community can vote in this poll to express support or opposition to the following action:

- Claim all aEthUSDS rewards earned by the Spark ALM Proxy in the Aave Core market (roughly 243,167 aUSDS)
