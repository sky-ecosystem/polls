...
The community can vote in this poll to express support or opposition to the following changes to the stablecoin interest rate models for SparkLend on mainnet:
